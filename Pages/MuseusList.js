        ...
        <View style={styles.container}>
            ...
            <View style={styles.cardlist}>
                ...
                <View style={styles.column2}>
                   <Text style={styles.welcomeTxt}>Вам точно будет интересно!</Text>
                    <FlatList 
                        data={column2Data}
                        renderItem = {({item}) => {
                            return renderData(item)
                    ...
                    <Button style={styles.loginBtn} onPress = {()=> props.navigation.navigate("CoffeeShops")}>
                        <Text style={{color:"#eaf5db"}}>КОФЕЙНИ</Text>
