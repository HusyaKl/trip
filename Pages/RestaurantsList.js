        ...
        <View style={styles.container}>
            ...
            <View style={styles.cardlist}>
                ...
                <View style={styles.column2}>
                   <Text style={styles.welcomeTxt}>Здесь очень вкусно</Text>
                    <FlatList 
                        data={column2Data}
                        renderItem = {({item}) => {
                            return renderData(item)
                    ...
                    <Button style={styles.loginBtn} onPress = {()=> props.navigation.navigate("Bars")}>
                        <Text style={{color:"#eaf5db"}}>БАРЫ</Text>
